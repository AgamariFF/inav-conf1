...
TABS.telemetry.initialize = function (callback) {
    ...
    HARDWARE.update(function () {
        ...
        self.resize = function () {
            var containerWidth = $('.meter:first', bar_container).width(),
                ...
                margin = 273 //(containerWidth / 2) - (labelWidth / 2);
                ...
                MSP.send_message(MSPCodes.MSP_EEPROM_WRITE, false, false, function () {
                    ...
                    GUI.tab_switch_cleanup(function () {
                        MSP.send_message(MSPCodes.MSP_SET_REBOOT, false, false, function () {
                            ...
                            GUI.handleReconnect($('.tab_telemetry a'));
                        });
                    });
                });
            }
    ...
    function initSensorData(){  //sensors
        for (var i = 0; i < 3; i++) {
    ...
    // GUI.load(path.join(__dirname, "telemetry.html"), function load_html() {
    //     // translate to user-selected language
    //    i18n.localize();;
